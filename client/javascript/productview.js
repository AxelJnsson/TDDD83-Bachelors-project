...
function appendProducts(filteredproducts){
    ...
    $('.btnInfo').on("click" ,function (e) {
        ...
        $("#productModalFooter").append('<button type="button" class="btn btn-tonehub" data-dismiss="modal" onClick="buyProduct(this.value, this)" value="'+products[prod_id].product_id+'" id="addProductToCartButton">Lägg i varukorgen<span class="cart-item"></span></button>');
    });
