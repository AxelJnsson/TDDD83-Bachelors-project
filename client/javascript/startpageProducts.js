...
function appendStartProducts(products) {
    $("#startCard1").append("<div class='col-auto mb-3'><img class='card-img-top prodimg'  src='"+ products[9].image +"' alt='Card image cap' id='prodimg'><div class='card-body'><h5 class='card-title' style='font-size: 25px; font-weight: bold; height: 30px;'>" + products[9].name + "<br><br></h5><p style='font-weight: bold; display:inline;'>Skick: </p><p style='display:inline'>Begagnad</p><br><p style='font-weight: bold; display:inline;'>Kategori: </p><p style='display: inline'>"+ products[9].type +"</p><br><b><p style='font-weight: bold; display:inline'>Pris: </p><p style='display:inline; font-weight:normal'>" + products[9].price + "kr</p></b></div>" + "<button class='btn btn-secondary' style='font-size:10px' onclick='createProducts3(9)'>Visa info</button><button type='button' class='btn btn-tonehub' style='font-size:10px;' data-dismiss='modal' onClick='addProductDirectlyToCart(this.value, this)' value='" + products[9].product_id + "' id='addProductToCartButton'>Köp</button></div>");
    $("#startCard2").append("<div class='col-auto mb-3'><img class='card-img-top prodimg'  src='"+ products[31].image +"' alt='Card image cap' id='prodimg'><div class='card-body'><h5 class='card-title' style='font-size: 25px; font-weight: bold; height: 30px;'>" + products[31].name + "<br><br></h5><p style='font-weight: bold; display:inline;'>Skick: </p><p style='display:inline'>Begagnad</p><br><p style='font-weight: bold; display:inline;'>Kategori: </p><p style='display: inline'>"+ products[31].type +"</p><br><b><p style='font-weight: bold; display:inline'>Pris: </p><p style='display:inline; font-weight:normal'>" + products[31].price + "kr</p></b></div>" + "<button class='btn btn-secondary' style='font-size:10px' onclick='createProducts3(31)'>Visa info</button><button type='button' class='btn btn-tonehub' style='font-size:10px;' data-dismiss='modal' onClick='addProductDirectlyToCart(this.value, this)' value='" + products[31].product_id + "' id='addProductToCartButton'>Köp</button></div>");
    $("#startCard3").append("<div class='col-auto mb-3'><img class='card-img-top prodimg'  src='"+ products[33].image +"' alt='Card image cap' id='prodimg'><div class='card-body'><h5 class='card-title' style='font-size: 25px; font-weight: bold; height: 30px;'>" + products[33].name + "<br><br></h5><p style='font-weight: bold; display:inline;'>Skick: </p><p style='display:inline'>Begagnad</p><br><p style='font-weight: bold; display:inline;'>Kategori: </p><p style='display: inline'>"+ products[33].type +"</p><br><b><p style='font-weight: bold; display:inline'>Pris: </p><p style='display:inline; font-weight:normal'>" + products[33].price + "kr</p></b></div>" + "<button class='btn btn-secondary' style='font-size:10px' onclick='createProducts3(33)'>Visa info</button><button type='button' class='btn btn-tonehub' style='font-size:10px;' data-dismiss='modal' onClick='addProductDirectlyToCart(this.value, this)' value='" + products[33].product_id + "' id='addProductToCartButton'>Köp</button></div>");
